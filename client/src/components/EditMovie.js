...
const [movieCategory,setMovieCategory] = useState(movie.category);
const [movieDate,setMovieDate] = useState(movie.publicationDate);
...
const onSubmit = (e)=>{
  ...
  <div className="col-12 md:col-6 lg:col-3">
  <Button type="submit" className="ml-3"label="Edit Movie" />
  </div>
  </div>
  </form>
};
